function onChangeForm() {
  var periodFactValues = getParametrValue(sourceSheetID, parametrSheetName, ['factPeriod', 'factPeriod-1']); // Обновляем список периода
  var periodBudgetValues = getParametrValue(sourceSheetID, parametrSheetName, ['budgetPeriod', 'budgetPeriod+1', 'budgetPeriod+2']); // Обновляем список периода бюджета

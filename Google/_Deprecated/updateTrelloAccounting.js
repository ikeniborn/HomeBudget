function updateTrelloAccounting(postObject) {
  try {
    ...
    if (postObject.account == 'Остатки') {
      ...
      ss.appendRow([insertdate, newPeriod, postObject.listName, postObject.mvz, postObject.bill, postObject.account, postObject.nomenclature, postObject.sum, postObject.comment, postObject.actionId, sourceSheetName])
    } else {

...
var board_id = "5dcae886588de3760f5d6ffa"; //https://trello.com/b/fXSbKPpT/api
...
function loadFromTrello() {
  try {
    ...
    //    var ss = SpreadsheetApp.openById("1Vuy--i4QlcSyAmQbP6OOSaaKGRSbz4sG08193FDLiwA").getSheetByName(sheetName).clear();
    var ss = SpreadsheetApp.openById("1Vuy--i4QlcSyAmQbP6OOSaaKGRSbz4sG08193FDLiwA").getSheetByName(sheetName);
    //   var ss = SpreadsheetApp.openById("1Vuy--i4QlcSyAmQbP6OOSaaKGRSbz4sG08193FDLiwA").getSheetByName(sheetName);

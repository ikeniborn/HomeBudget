...
var ssId = '1Vuy--i4QlcSyAmQbP6OOSaaKGRSbz4sG08193FDLiwA';
...
function initializeGlobalParametersIfNeeded() {
  ...
  var parametersSheet = SpreadsheetApp.openById(ssId).getSheetByName(PARAMETERS_SHEET_NAME) ? SpreadsheetApp.openById(ssId).getSheetByName(PARAMETERS_SHEET_NAME) : SpreadsheetApp.openById(ssId).insertSheet(PARAMETERS_SHEET_NAME);
